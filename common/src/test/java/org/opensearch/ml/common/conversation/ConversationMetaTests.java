...
public class ConversationMetaTests {
    ...
    public void test_toString() {
        ...
        assertEquals(
            "{id=test_id, name=test meta, created=1970-01-01T00:00:00.123Z, updated=1970-01-01T00:00:00.123Z, user=admin, application_type=neural-search, additional_infos=null}",
